...
extern "C"
JNIEXPORT void JNICALL
Java_com_libyuv_util_YuvUtil_yuy2ToNv21
    ...
    jbyte *dst_i420_data = (jbyte *) malloc(sizeof(jbyte) * width * height * 3 / 2);
    //yuy2toi420
    YUY2ToI420(src_yuy2_data, width, height, dst_i420_data);
    env->ReleaseByteArrayElements(yuy2Src, src_yuy2_data, 0);
    //i420tonv21
    jbyte *dst_nv21_data = env->GetByteArrayElements(nv21Dst, NULL);
    I420ToNv21(dst_i420_data, width, height, dst_nv21_data);
    free(dst_i420_data);
